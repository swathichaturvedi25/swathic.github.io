    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        >
          ...
          <Ionicons name={showTerms ? 'chevron-up' : 'chevron-down'} size={20} color="#ffd21f" />
        </TouchableOpacity>
        ...
        >
          <View style={styles.sectionToggleRow}>
            <Ionicons name="layers-outline" size={18} color="#ffd21f" />
            <Text style={styles.sectionToggleText}>Mana & Other Terms</Text>
          </View>
          <Ionicons name={showMana ? 'chevron-up' : 'chevron-down'} size={20} color="#ffd21f" />
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  manaCard: {
    ...
    marginBottom: 6,
    borderWidth: 1,
    borderColor: 'rgba(255, 210, 31, 0.15)',
  },
  manaLetter: {
    width: 28,
    fontSize: 15,
