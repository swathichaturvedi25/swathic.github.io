    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => setShowFingerInfo(true)} style={styles.infoButton}>
          <Ionicons name="hand-left" size={24} color="#ff2d1f" />
        </TouchableOpacity>
      </View>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        >
          <View style={styles.sectionToggleRow}>
            <Ionicons name="book-outline" size={18} color="#ff2d1f" />
            <Text style={styles.sectionToggleText}>Words Used in Tala</Text>
          </View>
          <Ionicons name={showTerms ? 'chevron-up' : 'chevron-down'} size={20} color="#ff2d1f" />
        </TouchableOpacity>
        ...
        >
          <View style={styles.sectionToggleRow}>
            <Ionicons name="layers-outline" size={18} color="#ff2d1f" />
            <Text style={styles.sectionToggleText}>Mana & Other Terms</Text>
          </View>
          <Ionicons name={showMana ? 'chevron-up' : 'chevron-down'} size={20} color="#ff2d1f" />
        </TouchableOpacity>
        ...
        <View style={styles.practiceNote}>
          <Ionicons name="bulb-outline" size={24} color="#ff2d1f" />
          ...
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowFingerInfo(false)}>
                <Ionicons name="close-circle" size={32} color="#ff2d1f" />
              </TouchableOpacity>
            </View>
            ...
            <ScrollView style={styles.modalScroll}>
              ...
              <View style={styles.modalNote}>
                <Ionicons name="sparkles" size={20} color="#ff2d1f" />
...
const styles = StyleSheet.create({
  ...
  definitionBox: {
    ...
    marginBottom: 12,
    borderWidth: 1,
    borderColor: 'rgba(255, 45, 31, 0.3)',
  },
  definitionLabel: {
    fontSize: 11,
    fontWeight: '700',
  ...
  layaChip: {
    flex: 1,
    backgroundColor: 'rgba(255, 45, 31, 0.08)',
    borderRadius: 10,
    paddingVertical: 10,
    paddingHorizontal: 8,
    alignItems: 'center',
    borderWidth: 1,
    borderColor: 'rgba(255, 45, 31, 0.2)',
  },
  layaChipText: {
    fontSize: 12,
    fontWeight: '700',
  ...
  sectionToggle: {
    ...
    marginBottom: 4,
    padding: 14,
    backgroundColor: 'rgba(255, 45, 31, 0.06)',
    borderRadius: 12,
    borderWidth: 1,
    borderColor: 'rgba(255, 45, 31, 0.25)',
  },
  sectionToggleRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  manaCard: {
    ...
    marginBottom: 6,
    borderWidth: 1,
    borderColor: 'rgba(255, 45, 31, 0.15)',
  },
  manaLetter: {
    width: 28,
    fontSize: 15,
  ...
  talaDetails: {
    ...
    paddingTop: 16,
    borderTopWidth: 1,
    borderTopColor: 'rgba(255, 45, 31, 0.15)',
  },
  talaDetailRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
