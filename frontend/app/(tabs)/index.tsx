            ...
            goals.map((goal) => (
              <View key={goal.id} style={styles.goalCard}>
                <View style={styles.goalIcon}>
                  <Ionicons name="flag" size={20} color="#ffd21f" />
                </View>
          ...
          <View style={styles.sectionHeader}>
            ...
            >
              {insightsLoading ? (
                ...
                <Ionicons name="refresh" size={20} color="#ffd21f" />
              )}
            </TouchableOpacity>
          </View>
